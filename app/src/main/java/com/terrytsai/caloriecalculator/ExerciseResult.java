...
public class ExerciseResult extends AppCompatActivity {
    ...
    String exerciseName;
    String exerciseType;
    double amountExercise;
    double conversionRate;
    double calculatedCal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            amountExercise = extras.getDouble("amountExercise");
            conversionRate = extras.getDouble("conversionRate");
            calculatedCal = amountExercise / conversionRate;
            result.setText("You have burned " + format.format(calculatedCal) + " calories");
        }

        final Calories currentCal = new Calories(calculatedCal);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                ...
                Toast.makeText(ExerciseResult.this, "Selected :"
...
//        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent myIntent = new Intent(getApplicationContext(), EnterExerciseAmount.class);
        myIntent.putExtra("exerciseName", exerciseName);
        myIntent.putExtra("exerciseType", exerciseType);
        myIntent.putExtra("conversionRate", conversionRate);
